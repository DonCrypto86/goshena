...
export function Catalog({ products }: { products: Product[] }) {
  ...
  return <>
    <header className="thai-header"><div className="shell thai-nav">
      <a href="#inicio" className="thai-wordmark"><Image src="/brand/goshena-logo.png" width={94} height={64} alt="Goshena" priority/></a>
    ...
    <section className="thai-hero" id="inicio"><div className="goshena-hero-mark" aria-hidden="true"><Image src="/brand/goshena-logo.png" alt="" fill priority sizes="(max-width: 720px) 76vw, 42vw"/></div><div className="shell"><span className="eyebrow">{t.cuisine}</span><h1>{t.hero}<br/><em>{t.near}</em></h1><p>{t.intro} <strong>{t.introStrong}</strong></p><a className="primary" href="#menu">{t.viewMenu}</a></div></section>
    ...
    <footer className="thai-footer shell"><span className="thai-footer-brand"><Image src="/brand/goshena-logo.png" width={80} height={55} alt="Goshena"/></span><a href="https://wendelo.online" target="_blank" rel="noreferrer"><Image src="/brand/wendelo-mark.png" width={20} height={18} alt=""/> {t.productOf} wendelo.online</a></footer>
