...
type FlyerTheme = "liz" | "thai" | "hacienda" | "goshena";
...
async function renderFlyer(products: Product[], catalogName: string, subtitle: string, catalogLogoUrl: string, theme: FlyerTheme) {
  ...
  const palette = theme === "goshena"
    ? { top: "#0a1a1f", bottom: "#2a6660", accent: "#d8b848", card: "#f7f4ec", ink: "#122229", soft: "#7c9299" }
    : theme === "hacienda"
  ...
  context.fillStyle = theme !== "liz" ? "#fffaf0" : palette.ink;
  context.font = "700 76px Georgia, serif";
  context.fillText(catalogName, 540, 190);
  context.fillStyle = theme !== "liz" ? "#d7c9ab" : palette.soft;
