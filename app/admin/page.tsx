...
function SetupNotice() {
  return <main className="admin-shell setup"><div className="admin-brand"><strong>Goshena</strong><small>Administración</small></div><div className="panel"><span className="eyebrow">Configuración inicial</span><h1>Conectá Supabase</h1><p>Agregá las variables indicadas en <code>.env.example</code>. Después, el acceso privado y los productos quedarán disponibles aquí.</p><a href="/">Volver al catálogo</a></div></main>;
}
